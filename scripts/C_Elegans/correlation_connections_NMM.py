...
ax[0].scatter(gamma_g_connectome_wt,np.abs(w_fitted_wt), alpha=0.8, color="blue", label="Wild Type")
ax[0].scatter(gamma_g_connectome_unc31, np.abs(w_fitted_unc31), alpha=0.8, color="orange", label="Mutant")
ax[0].set_xlabel(r"$\gamma_g$ (connectome)")
...
gamma_g_corr_wt = np.corrcoef(gamma_g_connectome_wt, np.abs(w_fitted_wt))[0, 1]
gamma_g_corr_unc31 = np.corrcoef(gamma_g_connectome_unc31, np.abs(w_fitted_unc31))[0, 1]

gamma_s_corr_wt = np.corrcoef(gamma_s_connectome_wt, np.abs(w_fitted_wt))[0, 1]
gamma_s_corr_unc31 = np.corrcoef(gamma_s_connectome_unc31, np.abs(w_fitted_unc31))[0, 1]
