...
function main()
    ...
    figures_path = "/home/gabriel/figuras/qualification/NEGF_HH_DELTA_SYNAPSE_$(N)neurons_LINEAR_2PATHS_tf$(tf)/syn_$(minimum(Es))_stim_$(I_ext)/"
    
    for i=1:N
        mkpath(figures_path*"neuron$(i)/")
    end

    data_path = "/home/gabriel/dados/qualification/NEGF_HH_DELTA_SYNAPSE_$(N)neurons_LINEAR_2PATHS_tf$(tf)/syn_$(minimum(Es))_stim_$(I_ext)/"
