...
np.savetxt("plots/AconnHopDepth2.txt", np.array([np.array(labels).astype(float), probs]))
plt.savefig("plots/AconnHopDepth2.pdf", bbox_inches='tight')
...
np.savetxt("plots/AconnHopDepth.txt", np.array([min_anatomical_hops_flat,min_anatomical_hops_all_flat]).T, delimiter=",")
plt.savefig("plots/AconnHopDepth.pdf", bbox_inches='tight')
