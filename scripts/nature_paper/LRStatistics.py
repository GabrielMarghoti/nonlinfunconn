...
plt.savefig("plots/Miscellaneous_Supplement_LR_statistics.pdf")
plt.savefig("plots/Response_Statistics_LR_statistics.pdf")
...
np.savetxt("plots/LR_statistics.txt", np.array([ypos,Probs_numbers]))
plt.savefig("plots/LR_statistics.pdf", bbox_inches='tight')
plt.savefig("plots/Response_Statistics_LR_statistics_justtwo.pdf", bbox_inches='tight')
...
ax1.set_xscale("log")
plt.savefig("plots/LR_statistics3.pdf")
plt.savefig("plots/Inhibitory_Excitatory3.pdf")
...
ax1.set_ylabel("Inhibitory to Excitatory Ratio")
#ax1.set_xscale("log")
plt.savefig("plots/LR_statistics4.pdf")
plt.savefig("plots/Inhibitory_Excitatory_Ratio4.pdf")
...
#ax1.set_xscale("log")
plt.savefig("plots/LR_statistics5.pdf")
plt.savefig("plots/Inhibitory_Fraction5.pdf")
...
plt.axvline(0.05)
#ax1.set_xscale("log")
#plt.savefig("plots/LR_statistics.pdf")
#plt.savefig("plots/Inhibitory_Excitatory_Ratio_lessthan.pdf")
...
#plt.savefig("plots/LR_statistics.pdf")
#plt.savefig("plots/Response_Statistics/Inhibitory_Fraction_lessthan.pdf", bbox_inches='tight')
np.savetxt("plots/Inhibitory_Fraction_lessthan.txt", np.array([q_sorted[np.where(q_sorted<0.1)], fraction[np.where(q_sorted<0.1)]]).T,delimiter=",")
plt.savefig("plots/Inhibitory_Fraction_lessthan.pdf", bbox_inches='tight')
