...
_, q_mat = funa.get_kolmogorov_smirnov_q(inclall_occ2,return_tost=True,tost_th=1.2)
...
#plt.savefig("plots/LR_statistics_tost.pdf")
#plt.savefig("plots/LR_statistics_tost.pdf")
...
np.savetxt("plots/LR_statistics_tost.txt", np.array([ypos, Probs_numbers]))
#plt.savefig("plots/LR_statistics_tost.pdf", bbox_inches='tight')
#plt.savefig("plots/LR_statistics_justtwo_tost.pdf", bbox_inches='tight')
...
ax1.set_xscale("log")
#plt.savefig("plots/LR_statistics_tost.pdf")
#plt.savefig("plots/Inhibitory_Excitatory_tost.pdf")
...
#ax1.set_xscale("log")
#plt.savefig("plots/LR_statistics_tost.pdf")
#plt.savefig("plots/Inhibitory_Excitatory_Ratio_tost.pdf")
...
#ax1.set_xscale("log")
#plt.savefig("plots/LR_statistics_tost.pdf")
#plt.savefig("plots/Inhibitory_Fraction_tost.pdf")
...
#ax1.set_xscale("log")
#plt.savefig("plots/LR_statistics_tost.pdf")
#plt.savefig("plots/Inhibitory_Excitatory_Ratio_lessthan_tost.pdf")
...
plt.yticks(np.arange(0, 0.35, step=0.15), fontsize= 20)
plt.xticks(np.arange(0, 0.11, step=0.05), fontsize= 20)
#plt.savefig("plots/LR_statistics_tost.pdf")
#plt.savefig("plots/Inhibitory_Fraction_lessthan_tost.pdf", bbox_inches='tight')
np.savetxt("plots/Inhibitory_Fraction_lessthan_tost.txt", np.array([q_sorted[np.where(q_sorted<0.1)], fraction[np.where(q_sorted<0.1)]]))
plt.savefig("plots/Inhibitory_Fraction_lessthan_tost.pdf", bbox_inches='tight')
