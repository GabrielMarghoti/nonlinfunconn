...
if merge_bilateral:
    ...
    plt.savefig("plots/figS5/fraction_responding_merged.pdf")
else:
    #plt.savefig("/projects/LEIFER/Sophie/Figures/Robustness/fraction_responding_unmerged.pdf")
    #np.savetxt("plots/figS5/fraction_responding_unmerged.txt",fraction_respond_head)
    f = open("plots/figS5/fraction_responding_unmerged.txt","w")
    ...
    f.write(s)
    f.close()
    plt.savefig("plots/figS5/fraction_responding_unmerged.pdf")
fig2.clf()
...
if merge_bilateral:
    ...
    plt.savefig("plots/figS5/occ3_merged.pdf")
else:
    #plt.savefig("/projects/LEIFER/Sophie/Figures/Robustness/occ3_unmerged.pdf")
    plt.savefig("plots/figS5/occ3_unmerged.pdf")
fig3.clf()
...
if merge_bilateral:
    ...
    plt.savefig("plots/figS5/variability_merged.pdf")
else:
    #plt.savefig("/projects/LEIFER/Sophie/Figures/Robustness/variability_unmerged.pdf")
    #np.savetxt("plots/figS5/variability_unmerged.txt",variability_matrix_head)
    f = open("plots/figS5/variability_unmerged.txt","w")
    f.write(",".join(funa.head_ids[sorter_j])+"\n")
    s = ""
    ...
    f.write(s)
    f.close()
    plt.savefig("plots/figS5/variability_unmerged.pdf")
fig1.clf()
