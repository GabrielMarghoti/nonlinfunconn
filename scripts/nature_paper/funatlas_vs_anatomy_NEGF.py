...
actconn = np.loadtxt("/home/gabrielm/paper_reproduction/simulations/activity_connectome_sign2/activity_connectome_no_merge.txt")
actconn_ph = funa.reduce_to_pharynx(actconn)
actconn_fit_wt = np.loadtxt("/home/gabrielm/paper_reproduction/simulations/activity_connectome_sign2_inverted/activity_connectome_no_merge.txt")
actconn_fit_wt_ph = funa.reduce_to_pharynx(actconn_fit_wt)
actconn_fit_unc31 = np.loadtxt("/home/gabrielm/paper_reproduction/simulations/activity_connectome_sign2_inverted_unc31/activity_connectome_no_merge.txt")
actconn_fit_unc31_ph = funa.reduce_to_pharynx(actconn_fit_unc31)

intensity_map_wt = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache.txt")
occ3_wt = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_occ3.txt")
q_wt = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_q.txt")
tost_q_wt = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_tost_q.txt")
...
intensity_map_unc31 = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_unc31.txt")
occ3_unc31 = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_occ3_unc31.txt")
q_unc31 = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_q_unc31.txt")
tost_q_unc31 = np.loadtxt("/home/gabrielm/paper_reproduction/funatlas_intensity_map_cache_tost_q_unc31.txt")
...
#occ1slowbool = np.loadtxt("occ1slowbool.txt")
...
pp.scatter_hist(x2, y2, ax, ax_histx, ax_histy, label=r"functionally not connected ($q_{eq}<0.05$)", binsx=binsx, binsy=binsy, alpha_scatter=0.2, alpha_hist=0.5, color=c_not_in_wt, density=True)
pp.scatter_hist(x1, y1, ax, ax_histx, ax_histy, label=r"functionally connected ($q<0.05$)",binsx=binsx,binsy=binsy,alpha_scatter=0.2,alpha_hist=0.5,color=c_in_wt, density=True)
