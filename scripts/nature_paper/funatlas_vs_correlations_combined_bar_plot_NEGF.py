...
fig.tight_layout()
np.savetxt("plots/fig6/funatlas_vs_correlations_nth.txt",np.array([r_conn_spont,r_kuncorr_spont_opt,r_kuncorr_spont,r_ck_spont_opt,r_ck_spont]))
fig.savefig("plots/fig6/funatlas_vs_correlations_nth.pdf",dpi=300,bbox_inches="tight")
plt.show()
